<template>
    <view>
		...
		<image class = "floating-button" src="https://william.fit:8082/static/default/plus.png" @click="onpress"></image>
</template>
...
<script setup>
	...
	const onpress=()=>{
		console.log('教师端跳转到上传文件界面'),
		uni.navigateTo({
			url:'/pages/hygiene/hygieneGradesSubmit'
		})
	}
	//vue3不用onLoad， 用onMount来替代
	onMounted(()=>{
		//搜索热点
		// data.search_list_hot = [
		// 	'大物','高数','Java'
		// ]
	})
</script>
