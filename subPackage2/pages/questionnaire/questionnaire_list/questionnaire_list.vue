	...
	<view class="notice-list">
		<view  v-for="(item,index) in data.questionnairelist" :key="index" class="bar,questionitem"  @click="gotonaire(item)">
			<uni-section  :title="item.name" type="line" titleFontSize=42rpx :sectionstyle="item.isEnd?'opacity: 0.5':''" >
				...
				<questionnaireVue :naireinfo="item"></questionnaireVue>
			</uni-section>
		</view>
	</view>
	</view>
	<view>
		<image class = "addnaireicon" src="https://william.fit:8082/static/default/plus.png" @click="goto('../addquestionnaire/addquestionnaire')"></image>
	</view>
</template>
...
import questionnaireVue from "../../../../components/questionnaire/questionnaire.vue";
