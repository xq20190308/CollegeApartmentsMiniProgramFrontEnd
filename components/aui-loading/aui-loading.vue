<template>
	...
	<!-- 6、特殊风格弹窗 -> 静态图片 -->
	<view class="aui-loading aui-loading-squarefour" :class="{'aui-loading-squarefour-style-1': theme==1, 'aui-loading-squarefour-style-2': theme==2}" v-else-if="SHOW && type == 6">
		<view class="aui-mask" v-if="mask" @touchmove.stop.prevent></view>
		<view class="aui-loading-main" :style="{background: styles.background, zIndex: styles.zIndex, 'box-shadow': 'none!important'}">
			<!-- <view> -->
